      ...
      $j=1;
        ...
        foreach ($data as $key => $value) {
          ...
          echo '<div class="col-sm-12">
                  <div style="padding: 10px;border:solid 1px #eee;border-radius: 4px;border-left: solid 4px #b1d7ff;font-size: 12px;margin-bottom:15px;">
                    <div class="row">
                      <div class="col-sm-2">
                      <div style="padding: 6px;text-align:center;background-color:#ecf0ff;">
