...
<html lang="en">
<head>
  <title>Ahrvo Block Explorer</title>
  <meta charset="utf-8">
   ...
   <div style="padding:30px;">
    ...
    <table class="table table-striped" style="font-size: 13px" >
      ...
      <tr>
        ...
        <td><?php echo hexdec($data['result']['blockNumber']); ?></td>
      </tr>
      ...
      <tr style="background-color: #f2f7ff">
        ...
        <td><?php echo hexdec($data['result']['cumulativeGasUsed']); ?></td>
      </tr>
      ...
      <tr style="background-color: #f2f7ff">
        ...
        <td><?php echo hexdec($data['result']['gasUsed']); ?></td>
      </tr>
